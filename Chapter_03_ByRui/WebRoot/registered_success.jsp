...
<html>
  ...
  <body>
    ...
    <h3 align="center">用户名：<%=username %></h3>
    <h3 align="center">密    码：<%=pwd %></h3>
    <h3 align="center">性    别：<%=sex %></h3>
    <h3 align="center">专    业：<%=major %></h3>
    <h3 align="center">兴    趣：<%=habit %></h3>
    <h3 align="center">个人简介：<%=personalIntroduction %></h3>
    <h4 align="center"><a href="login.jsp">登录</a></h4>
